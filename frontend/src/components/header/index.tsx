...
const Header = () => {
  return (
    <header className="flex flex-col items-center bg-zinc-100 border border-gray-300 shadow-sm rounded-md p-5 mt-5 md:mt-20">
      ...
      <p className="hidden md:block font-normal text-blue-950 pt-3 w-2/3 md:w-3/4 text-center lg:text-xl">
